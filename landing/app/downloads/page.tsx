...
const MAC_DOWNLOAD_LINK = "https://github.com/i-am-neon/fe-infinity-lt/releases/download/v1.0.3/FE.Infinity-1.0.3-arm64.dmg";
const WINDOWS_DOWNLOAD_LINK = "https://github.com/i-am-neon/fe-infinity-lt/releases/download/v1.0.3/FE.Infinity-Setup-1.0.3.exe";
