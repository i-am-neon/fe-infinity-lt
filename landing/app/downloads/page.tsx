...
const MAC_DOWNLOAD_LINK = "https://github.com/i-am-neon/fe-infinity-lt/releases/download/v1.0.4/FE.Infinity-1.0.4-arm64.dmg";
const WINDOWS_DOWNLOAD_LINK = "https://github.com/i-am-neon/fe-infinity-lt/releases/download/v1.0.4/FE.Infinity-Setup-1.0.4.exe";
