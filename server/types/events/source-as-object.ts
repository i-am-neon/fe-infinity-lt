...
## remove_portrait
Removes a portrait from the screen. This should be used before adding a new portrait to the same position, or when a character leaves the scene.
Required args: character firstName
