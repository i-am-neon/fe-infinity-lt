...
export function ChapterGeneratorLoader({
    ...
    description = "The AI is creating your next chapter based on your gameplay. This typically takes around 5 minutes, and the game will launch automatically when complete. Do not close this window!",
